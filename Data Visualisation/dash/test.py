...
def update_output_container(input_year, selected_statistics):
    if selected_statistics == 'Recession Period Statistics':
        ...
        return [
            html.Div(className='chart-item', children=[html.Div(
                children=R_chart1), html.Div(children=R_chart3)], style={'display': 'flex'}),
            html.Div(className='chart-item', children=[html.Div(
                children=R_chart2), html.Div(children=R_chart4)], style={'display': 'flex'})
        ]
    ...
    # TASK 2.6: Create and display graphs for Yearly Report Statistics
        ...
        Y_chart4 = dcc.Graph(figure=px.pie(
            exp_data, values=exp_data.values, names=exp_data.index))
